...
.controller('getDataCtrl', function($scope,$compile) {
 ...
 $scope.initialise=function() {
        var myLatlng = new google.maps.LatLng(30.648670261474,76.809466440475);
        ...
        var createMarker = function (info){
            var marker = new google.maps.Marker({
                position: new google.maps.LatLng(info.delivery_latitude, info.delivery_longitude),
                map: $scope.map,
                animation: google.maps.Animation.DROP,
                title: info.delivery_address
            });
            marker.content = '<div class="infoWindowContent">' + info.delivery_address + '</div>';
            google.maps.event.addListener(marker, 'click', function(){
